...
export function enableConfigs(): void {
  ...
  try {
    getConfig(
      getGlobalClaudeFile(),
      createDefaultGlobalConfig,
      false /* do not throw on invalid for robust web server */,
    )
  } catch (e) {
    console.error('Initial config read failed, but suppressing to keep web server alive', e)
  }
...
// Ensure it's enabled immediately for the Web server context
enableConfigs()
